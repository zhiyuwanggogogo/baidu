 ...
 */
package com.example.sdkdemo.oldif;
...
import com.example.sdkdemo.EventHandler;
...
public class OldDemoGuideActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = BNRouteGuideManager.getInstance().onCreate(this, (BNRouteGuideManager.OnNavigationListener) mOnNavigationListener);
                ...
                public void handleMessage(android.os.Message msg) {
                    if (msg.what == MSG_SHOW) {
                        ...
                        BNRouteGuideManager.getInstance().resetEndNodeInNavi(
                                new BNRoutePlanNode(116.21142, 40.85087, "百度大厦11", null, com.baidu.navisdk.adapter.impl.BNRoutePlanNode.CoordinateType.GCJ02));
                    }
                }
            };
        }
    ...
    private IBNRouteGuideManager.OnNavigationListener mOnNavigationListener = new IBNRouteGuideManager.OnNavigationListener() {
