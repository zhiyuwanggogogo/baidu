 ...
 */
package com.example.sdkdemo.newif;
    ...
    private void initListener() {
            ...
            mWgsNaviBtn.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View arg0) {
                    if (BaiduNaviManagerFactory.getBaiduNaviManager().isInited()) {
                        routeplanToNavi(com.baidu.navisdk.adapter.impl.BNRoutePlanNode.CoordinateType.WGS84);
                    }
                }
        ...
        if (mGcjNaviBtn != null) {
            mGcjNaviBtn.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View arg0) {
                    if (BaiduNaviManagerFactory.getBaiduNaviManager().isInited()) {
                        routeplanToNavi(com.baidu.navisdk.adapter.impl.BNRoutePlanNode.CoordinateType.GCJ02);
                    }
                }
        ...
        if (mDb06ll != null) {
            mDb06ll.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View arg0) {
                    if (BaiduNaviManagerFactory.getBaiduNaviManager().isInited()) {
                        routeplanToNavi(com.baidu.navisdk.adapter.impl.BNRoutePlanNode.CoordinateType.BD09LL);
                    }
                }
            });
        }
...
//         BaiduNaviManagerFactory.getTTSManager().initTTS(mTTSCallback);
    ...
    private void routeplanToNavi(final int coType) {
        ...
        switch (coType) {
            case com.baidu.navisdk.adapter.impl.BNRoutePlanNode.CoordinateType.GCJ02: {
            ...
            case com.baidu.navisdk.adapter.impl.BNRoutePlanNode.CoordinateType.WGS84: {
            ...
            case com.baidu.navisdk.adapter.impl.BNRoutePlanNode.CoordinateType.BD09_MC: {
                sNode = new BNRoutePlanNode(12947471, 4846474, "百度大厦", "百度大厦", coType);
                eNode = new BNRoutePlanNode(12958160, 4825947, "北京天安门", "北京天安门", coType);
                break;
            }
            case com.baidu.navisdk.adapter.impl.BNRoutePlanNode.CoordinateType.BD09LL: {
